...
def run_network(model=None, data=None):
    ...
    if data is None:
        ...
        # X_train, y_train, X_test, y_test = get_split_prep_data(0, 2100, 1400, 2800)
        X_train, y_train, X_test, y_test = get_split_prep_data(0, 86103, 86103, 172206)
