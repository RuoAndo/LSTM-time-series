...
int main(int argc, char *argv[]){
  ...
  */
    ...
    if (argc != 4)
    {
      std::cout << "usage: ./test [epoch] [predicted file] [bpProp_len]";
      return 0;
    }
    ...
    int epoch_size = atoi(argv[1]);
    int batch_size = 10;
    int bprop_len = atoi(argv[3]);
    ...
    */
    ...
    std::string log_filename = "log-" + string(argv[1]) + "-" + string(argv[2]) + "-" + string(argv[3]) + "-" + string(buffer);
    ...
    */    
    ...
    std::string filename = string(argv[2]) + "-" + to_string(epoch_size) + "-" + to_string(bprop_len) + "-" + string(buffer);
