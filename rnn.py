...
if __name__ == '__main__':
    ...
    N_validated = len(data) - N_train

    X_train, X_validation, Y_train, Y_validation = \
        train_test_split(X, Y, test_size=N_validated)
    ...
    observed = [f[i] for i in range(maxlen)]
    ...
    plt.plot(observed, linestyle='dashed', color='black')
